...
parser = argparse.ArgumentParser(
    description='Pass in parameters for fire search.'
    )

parser.add_argument('--country',
                    type=str,
                    default='United States of America',  # US default
...
def main():
    ...
    if args.operation:  # if an operation is given
        if args.operation == 'mean':
            ...
            print(f'"{args.operation}" is an unrecognized operation name.')
            sys.exit(5)
